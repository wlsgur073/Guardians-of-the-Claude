...
2. **템플릿을 프로젝트에 복사**
   ...
   ```bash
   cp Claude-Code-Templates/ko-KR/templates/CLAUDE.md your-project/CLAUDE.md
   mkdir -p your-project/.claude
   cp Claude-Code-Templates/ko-KR/templates/.claude/settings.json your-project/.claude/settings.json
   ```
