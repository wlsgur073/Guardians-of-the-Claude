<!-- ─────────────────────────────────────────────
 ...
 Source: profile.json v1.2.0, recommendations.json v1.0.0
───────────────────────────────────────────────── -->
...
- Config: CLAUDE.md ✓, settings.json ✓, Rules 1, Agents 0, Hooks 1, MCP 0
...
### /secure — 2026-04-14
settings.json created with deny patterns, security rule file created, file-protection hook added
