...
예시: `guardians-of-the-claude` 플러그인은 프로젝트 프로파일, 결정 changelog, 최신 스킬 결과를 `local/` 하위 디렉토리에 저장합니다 (`project-profile.md`, `config-changelog.md`, `latest-{skill}.md`). 이 파일들을 통해 스킬들이 프로젝트 맥락, 사용자 선호도, 보류 중인 권장사항을 세션 간에 기억할 수 있습니다.
