...
| プラグイン | 内容 |
| -------- | ---- |
| [superpowers](https://github.com/obra/superpowers) | フル開発ワークフロー -- 仕様、設計、計画、subagent 駆動の実装。Claude が計画から外れることなく何時間も自律的に作業できます |
| [feature-dev](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/feature-dev) | 構造化された 7 フェーズの機能開発: 発見、コードベース探索、明確化のための質問、アーキテクチャ設計、実装、品質レビュー、要約 |
