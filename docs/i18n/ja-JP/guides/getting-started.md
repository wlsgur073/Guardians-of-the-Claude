...
- [マルチエージェントパターンガイド](multi-agent-patterns-guide.md) -- オーケストレーター-ワーカー、サブエージェント予算、並列ディスパッチ
- [ワークフローパターンガイド](workflow-patterns-guide.md) -- インタビュー優先の仕様策定、Writer/Reviewer、fan-out、worktrees
